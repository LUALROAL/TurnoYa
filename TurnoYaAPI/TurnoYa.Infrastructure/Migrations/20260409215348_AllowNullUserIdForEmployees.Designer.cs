...
namespace TurnoYa.Infrastructure.Migrations
{
    ...
    [Migration("20260409215348_AllowNullUserIdForEmployees")]
    partial class AllowNullUserIdForEmployees
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TurnoYa.Core.Entities.BusinessBreakTime", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TurnoYa.Core.Entities.BusinessSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TurnoYa.Core.Entities.BusinessTimeBlock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BusinessTimeBlocks");
                });

            modelBuilder.Entity("TurnoYa.Core.Entities.BusinessWorkingDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TurnoYa.Core.Entities.EmployeeServiceAssignment", b =>
                {
                    b.Property<Guid>("EmployeeId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TurnoYa.Core.Entities.User", b =>
                {
                    ...
                    b.Property<string>("GooglePhotoUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TurnoYa.Core.Entities.BusinessBreakTime", b =>
                {
                    b.HasOne("TurnoYa.Core.Entities.BusinessWorkingDay", "WorkingDay")
                        .WithMany("BreakTimes")
            ...
            modelBuilder.Entity("TurnoYa.Core.Entities.BusinessSchedule", b =>
                {
                    b.HasOne("TurnoYa.Core.Entities.Business", "Business")
                        .WithOne()
                        .HasForeignKey("TurnoYa.Core.Entities.BusinessSchedule", "BusinessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TurnoYa.Core.Entities.BusinessWorkingDay", b =>
                {
                    b.HasOne("TurnoYa.Core.Entities.BusinessSchedule", "BusinessSchedule")
            ...
            modelBuilder.Entity("TurnoYa.Core.Entities.EmployeeSchedule", b =>
                {
                    ...
                    b.HasOne("TurnoYa.Core.Entities.Employee", null)
                        .WithOne("Schedule")
                        .HasForeignKey("TurnoYa.Core.Entities.EmployeeSchedule", "EmployeeId1");
