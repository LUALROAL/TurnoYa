...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonButton, IonInput, IonItem, IonLabel, IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonSpinner, IonSegment, IonSegmentButton, IonAvatar, IonText, ToastController, AlertController } from '@ionic/angular/standalone';
...
@Component({
  ...
  template: `
    ...
    <ion-content class="ion-padding">
      ...
      <div *ngIf="!loading()">
        <!-- Tab Navigation -->
        <ion-segment [(ngModel)]="activeTab" class="mb-4">
              ...
              <form [formGroup]="passwordForm" (ngSubmit)="onChangePassword()">
                ...
                <div class="mt-4 p-3 bg-blue-50 rounded-lg text-sm">
                  ...
                  <ul class="list-disc list-inside space-y-1">
                    <li [class.line-through]="passwordForm.get('newPassword')?.value?.length >= 8">Mínimo 8 caracteres</li>
                    <li [class.line-through]="hasUpperCase()">Una mayúscula</li>
                    <li [class.line-through]="hasLowerCase()">Una minúscula</li>
                    <li [class.line-through]="hasDigit()">Un dígito</li>
                  </ul>
                </div>
...
export class ProfilePage implements OnInit, OnDestroy {
  ...
  protected onUpdateProfile(): void {
    ...
    if (Object.keys(updateData).length === 0) {
      this.notify.showInfo('No hay cambios para guardar');
  ...
  protected onChangePassword(): void {
    ...
    // Validación adicional con cambios
